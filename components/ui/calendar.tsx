...
function Calendar({
  ...
  // Definindo o intervalo permitido
  const startMonth = new Date(2004, 0)
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdowns: cn(
          "flex h-[--cell-size] w-full items-center justify-center gap-1.5 text-sm font-medium capitalize",
